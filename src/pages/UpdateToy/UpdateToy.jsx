...
const UpdateToy = () => {
  ...
  const handleUpdate = (e) => {
    ...
    fetch(`https://my-hero-server.vercel.app/update/${_id}`, {
      method: "PUT",
      headers: {
      ...
      <div className="card  w-1/2 mx-auto shadow-2xl bg-base-100">
        <div className="card-body">
          ...
          <form onSubmit={handleUpdate}>
            ...
            <span className="label-text-alt text-center text-red-600">{}</span>
            <div className="form-control mt-4">
              <button onClick={() => handleUpdate(_id)} className="my-btn">
                Update
              </button>
            </div>
          </form>
